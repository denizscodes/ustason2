...
const SMSButtonThree = ({ phone, islemdurumUc }) => {
  const sendSMS = async () => {
    try {
     ...
     message: `Merhaba USTA HOUSE müşterisi, işlem durumunuz: ${islemdurumUc}` || 'Durum bilgisi mevcut değil',
